		...
		//LIST ACTIVITY		
				mListView = (ListView)findViewById(R.id.listfriends2);
		 		...
		 		List<Map> data = GetSampleData();
		 		 SimpleAdapter adapter = new SimpleAdapter(this, (List<? extends Map<String, ?>>) data, R.xml.friends2item, new String[] { "foto", "nome", "punti" }, new int[] { R.id.foto, R.id.nome, R.id.punti });
