...
public class StatisticsActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//LIST BADGE		
		mListView_badge_won = (ListView)findViewById(R.id.list_badge_won);//premi vinti
		List<Map> data_badge_won = StatisticsMetod.RestituisciDati(1);
		SimpleAdapter adapter_badge_won = new SimpleAdapter(this, 
				(List<? extends Map<String, ?>>) data_badge_won, R.xml.statistics_item_badge2, new String[] 
						{"premio1", "premio2", "premio3" }, new int[] { R.id.premio1, R.id.premio2, R.id.premio3});
		mListView_badge_won.setAdapter(adapter_badge_won);
		mListView_badge_to_win = (ListView)findViewById(R.id.list_badge_to_win);//premi da vincere
		List<Map> data_badge_to_win = StatisticsMetod.RestituisciDati(2);
		SimpleAdapter adapter_badge_to_win = new SimpleAdapter(this, 
				(List<? extends Map<String, ?>>) data_badge_to_win, R.xml.statistics_item_badge2, new String[]
						{"premio1", "premio2", "premio3" }, new int[] { R.id.premio1, R.id.premio2, R.id.premio3});
